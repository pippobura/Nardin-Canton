...
public class Canton_Nardin_Banca {
  ...
  public static void presentazione() {
    ...
    System.out.println(
        "I tuoi soldi saranno divisi tra portafoglio e banca:\n"
            ...
            if (contoBanca <= 0) {
              ...
              do {
                ...
                try {
                  ...
                  scelta1 = Integer.parseInt(intero);
        ...
        case 6:
          {
            ...
            System.out.println(
                "Stipendio del mese " + (mese) + ": " + stipendio(stip, contoPortafoglio));
            Pause();
            break;
          }
